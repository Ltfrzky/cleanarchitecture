package com.lutfi.cleanarchitecture.view.activity.nfc
...
import com.lutfi.cleanarchitecture.util.nfc.NfcUtil
import com.lutfi.cleanarchitecture.util.nfc.parser.NdefMessageParser
...
//        TODO("Not yet implemented")
    ...
    private fun dumpTagData(tag: Tag): String {
        ...
        val id = tag.getId()
        sb.append("ID (hex): ").append(NfcUtil.toHex(id)).append('\n')
        sb.append("ID (reversed hex): ").append(NfcUtil.toReversedHex(id)).append('\n')
        sb.append("ID (dec): ").append(NfcUtil.toDec(id)).append('\n')
        sb.append("ID (reversed dec): ").append(NfcUtil.toReversedDec(id)).append('\n')
